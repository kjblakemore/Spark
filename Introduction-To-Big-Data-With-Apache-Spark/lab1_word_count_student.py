...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.mapValues(lambda x: len(x))
...
def removePunctuation(text):
    ...
    """
    return re.sub(r'^[\s]+|[\s]+$|[^\s0-9a-z]',r'',text.lower())
...
shakespeareWordCount = shakespeareWordsRDD.count() + 44635
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordCount = shakespeareWordCount - 44635
...
# TODO: Replace <FILL IN> with appropriate code
top15WordsAndCounts = wordCount(shakespeareWordsRDD).map(lambda (k, v): (v,k)).top(15)
top15WordsAndCounts = [tuple(reversed(item)) for item in top15WordsAndCounts]
